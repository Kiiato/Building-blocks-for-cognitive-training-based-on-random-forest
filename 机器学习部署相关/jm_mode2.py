...
# 导入模型并fit
rfc = joblib.load("/root/anaconda3/myprojects/jm/rfc_mode2.m")
# svc = joblib.load("/root/anaconda3/myprojects/jm/svc_model.m")
train_data = np.loadtxt('/root/anaconda3/myprojects/jm/jm_data_mode2.csv', dtype=int, delimiter=',', unpack=False)
X = train_data[:, :17]
y = train_data[:, 17]
